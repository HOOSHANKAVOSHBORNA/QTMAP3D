...
*/
#ifndef OSGEARTH_ANNOTATION_MY_PLACE_NODE_H
#define OSGEARTH_ANNOTATION_MY_PLACE_NODE_H 1
...
namespace osgEarth { namespace Annotation
{
     ...
     */
    class OSGEARTHANNO_EXPORT MyPlaceNode : public GeoPositionNode
    {
    public:
    ...
    private:
        ...
        MyPlaceNode(const MyPlaceNode& rhs, const osg::CopyOp& op =osg::CopyOp::DEEP_COPY_ALL) : GeoPositionNode(rhs, op) { }
...
#endif //OSGEARTH_ANNOTATION_MY_PLACE_NODE_H
