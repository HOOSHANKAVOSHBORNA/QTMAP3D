...
class AnnotatedNode:public osgEarth::Annotation::FeatureNode
{
public:
...
public:
    ...
    osgEarth::Color strokeColor() const;
    void setStrokeColor(const osgEarth::Color &newStrokeColor);

    AnnotatedNode::GeneralType type() const;
...
private:
    ...
    osgEarth::Features::Feature* mPathFeature;
