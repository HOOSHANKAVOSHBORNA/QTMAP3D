...
Item {
    ...
    onUnitsMultiChanged: {
        coneProperties.height = heightValue.value*unitsMulti
        coneProperties.radius = radiusValue.value*unitsMulti
    }
                            ...
                            Rectangle{
                                ...
                                ColorDialog {
                                    ...
                                    onAccepted: {
                                        ...
                                        coneProperties.fillcolor= fillColor.toString()
                                    }
                                    ...
                                    Row{
                                        ...
                                        Rectangle{
                                            ...
                                            TextInput {
                                                ...
                                                padding: 2
                                                anchors.fill: parent
                                                text: coneProperties.location.x.toFixed(9)
                                                font.pointSize: 10
                                                selectByMouse: true
                                                selectionColor: "dark green"
                                                validator: DoubleValidator {
                                                ...
                                                onTextChanged: {
                                                    coneProperties.location.x = text
                                                }
                                            }
                                        }
                                    }
                                    Row{
                                        ...
                                        Rectangle{
                                            ...
                                            TextInput {
                                                ...
                                                anchors.fill: parent
                                                font.pointSize: 10
                                                text: coneProperties.location.y.toFixed(9)
                                                selectByMouse: true
                                                selectionColor: "dark green"
                                                validator: DoubleValidator {
                                                    decimals: 13;
                                                ...
                                                onTextChanged: {
                                                    coneProperties.location.y = text
                                                }
                                            }
                                        }
                                    }
                                    Row{
                                        ...
                                        Rectangle{
                                            ...
                                            TextInput {
                                                ...
                                                anchors.fill: parent
                                                font.pointSize: 10
                                                text: coneProperties.location.z.toFixed(5)
                                                selectByMouse: true
                                                selectionColor: "dark green"
                                                validator: DoubleValidator {
                                                    decimals: 13;
                                                ...
                                                onTextChanged: {
                                                    coneProperties.location.z = text
                                                }
                                            }
                                        }
                                    }
