    ...
    :BaseModel(mapNode, parent)
{
    ...
    setStyle(rootStyle);
    //--create icon Nodes---------------------------------------------------------------------------
    osg::Image* redIcon = osgDB::readImageFile("../map3dlib/data/models/system-red.png");
    ...
    osg::Image* yellowIcon = osgDB::readImageFile("../map3dlib/data/models/system-yellow.png");
