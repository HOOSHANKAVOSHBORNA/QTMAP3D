...
{
public:
    explicit MoveableModelNode(MapItem* mapControler, const std::string& modelUrl, const std::string &iconUrl, QQmlEngine *engine, BookmarkManager *bookmark, QObject *parent = nullptr);
