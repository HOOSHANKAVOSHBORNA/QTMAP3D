...
void ModelAutoScaler::setDefaultScale(double defaultScale)
{
    _defaultScale = defaultScale;
}

void ModelAutoScaler::setMinScale(double minScale)
{
    _minScale = minScale;
}

void ModelAutoScaler::setMaxScale(double maxScale)
{
    _maxScale = maxScale;
}
