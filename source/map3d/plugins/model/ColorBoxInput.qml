...
Rectangle {
    ...
    function addHistory(addColor) {
        ...
        if (counter <= 9) {
            if (!counter)
                history.insert(0, {
                                   "historyColorSelect": addColor.toString(),
                                   "historyImageVisible": false
                               })
            else {
                for (var listIndex = 0; listIndex < counter; listIndex++)
                    if (history.get(
                                listIndex).historyColorSelect === addColor.toString(
                                )) {
                        history.setProperty(historyOldIndex,
                                            "historyImageVisible", false)
                        return
                    }
                history.insert(0, {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    onAccepted: {
                        colorCircle.color = "#" + "0".repeat(
                                    6 - text.length) + text
                        opacityColor = colorCircle.color
                        selectedColor = colorCircle.color
                        rInput.text = parseInt(colorCircle.color.toString(
                                                   ).replace("#", "").substring(
                                                   0, 2), 16)
                        gInput.text = parseInt(colorCircle.color.toString(
                                                   ).replace("#", "").substring(
                                                   2, 4), 16)
                        bInput.text = parseInt(colorCircle.color.toString(
                                                   ).replace("#", "").substring(
                                                   4, 6), 16)
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    onAccepted: {
                        var subStringValue = colorCircle.color.toString(
                                    ).substring(3, 7)
                        colorCircle.color = "#" + "0".repeat(
                                    2 - parseInt(text, 10).toString(
                                        16).length) + parseInt(text,
                                                               10).toString(
                                    16) + subStringValue
                        opacityColor = colorCircle.color
                        selectedColor = colorCircle.color
                        hexInput.text = colorCircle.color.toString(
                                    ).replace("#", "")
                        addHistory(colorCircle.color)
                        lstModel.setProperty(oldIndex, "imageVisible", false)
                    }
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    onAccepted: {
                        var subStringValue1 = colorCircle.color.toString(
                                    ).substring(1, 3)
                        var subStringValue2 = colorCircle.color.toString(
                                    ).substring(5, 7)
                        colorCircle.color = "#" + subStringValue1
                                + "0".repeat(2 - parseInt(text,
                                                          10).toString(16).length)
                                + parseInt(text,
                                           10).toString(16) + subStringValue2
                        opacityColor = colorCircle.color
                        selectedColor = colorCircle.color
                        hexInput.text = colorCircle.color.toString(
                                    ).replace("#", "")
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    onAccepted: {
                        ...
                        colorCircle.color = "#" + subStringValue + "0".repeat(
                                    2 - parseInt(text, 10).toString(
                                        16).length) + parseInt(text,
                                                               10).toString(16)
                        opacityColor = colorCircle.color
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        if (historyOldIndex !== historyNewIndex) {
                            historyRepeater.itemAt(
                                        historyOldIndex).checked = false
                        }
                        history.setProperty(historyNewIndex,
                                            "historyImageVisible", checked)
                        if (checked) {
