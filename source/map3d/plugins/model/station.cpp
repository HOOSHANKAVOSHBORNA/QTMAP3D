    ...
    :BaseModel(mapNode, parent)
{
    ...
    setStyle(rootStyle);
    //--create icon Nodes---------------------------------------------------------------------------
    osg::Image* redIcon = osgDB::readImageFile("../map3dlib/data/models/station-red.png");
    ...
    osg::Image* yellowIcon = osgDB::readImageFile("../map3dlib/data/models/station-yellow.png");
