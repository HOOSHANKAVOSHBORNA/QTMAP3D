...
#include <memory>
#include "../../map3d/map3dlib/compasswidget.h"
...
QT_MOC_LITERAL(1, 14, 12), // "rotateChange"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9), // "newRotate"
QT_MOC_LITERAL(4, 38, 11), // "pointChange"
QT_MOC_LITERAL(5, 50, 9) // "getRotate"

    },
    "CompassWidget\0rotateChange\0\0newRotate\0"
    "pointChange\0getRotate"
};
...
void CompassWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rotateChange((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->pointChange((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: { double _r = _t->getRotate();
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CompassWidget::rotateChange)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CompassWidget::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CompassWidget::pointChange)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CompassWidget::rotateChange(double _t1)
{
...
// SIGNAL 1
void CompassWidget::pointChange(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
